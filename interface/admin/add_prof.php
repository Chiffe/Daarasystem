...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Admin | Ajouter un professeur</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green"> Admin
                        <small class="font-green">Ajouter un professeur</small>
                    </h1>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="add_prof.php">Ajouter un professeur</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Ajouter un professeur</span>
                                    </div>
                                </div>
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 col-md-3">
                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                <input type="text" class="form-control" name="pnom_prof" required="required" id="pnom_prof">
                                                                <label for="pnom_prof">Prénom*</label>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-6 col-md-3">
                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                <input type="text" class="form-control" name="nom_prof" required="required" id="nom_prof">
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <textarea class="form-control" name="adresseprof" id="adresseprof" required="required" rows="4"></textarea>
                                                        <label for="adresseprof">Adresse*</label>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                <input type="email" class="form-control" name="emailprof" required="required" id="emailprof">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 col-md-3">
                                                            <div class="form-group form-md-line-input form-md-floating-label">
                                                                <input type="number" min="0" max="25" name="nbrenf" class="form-control" id="nbrenf">
