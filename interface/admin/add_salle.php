            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green"> Admin
                        <small class="font-green">Créer une salle</small>
                    </h1>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="add_salle.php">Créer une salle</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Ajouter une salle</span>
                                    </div>
                                </div>
                                            ...
                                            <form role="form" action="undefined" method="post">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" name="nomsalle" required="required" id="nomsalle">
                                                        <label for="nomsalle">Nom de la salle*</label>
                                                        <span class="help-block font-green">Exemple de message d'information</span>
                                                    </div>
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="number" min="1" max="100" required="required" name="effsalle" class="form-control" id="effsalle" value="1">
                                                        <label for="effsalle">Effectif de la salle*</label>
