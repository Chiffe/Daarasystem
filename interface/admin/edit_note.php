...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Admin | Modifier des notes</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green"> Admin
                        <small class="font-green">Modifier des notes</small>
                    </h1>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="edit_note.php">Modifier des notes</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Modifier des notes</span>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-xs-12 col-md-6 col-md-offset-3">
                                            <form role="form" action="undefined" method="post">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <select class="form-control change_field" required="required" name="trimes" id="trimes">
                                                            <option value=""></option>
                                                    ...
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <select class="form-control change_field" required="required" name="id_matiere" id="id_matiere">
                                                            <option value=""></option>
                                                        </select>
                                                        <label for="id_matiere">Matière*</label>
                                                        <span class="help-block font-green">Sélectionnez une classe pour choisir une matière</span>
                                                    </div>
                                                    <select title="Elève" class="form-control change_field" name="id_eleve" required="required" id="id_eleve"></select>
                                                    <legend class="margin-top-20">Liste des devoirs<span id="label_matiere" class="toshow"></span></legend>
                                                    <p class="text-center tohide">Remplissez tous les champs précédents</p>
                                                    <div id="cont_devoirs_edit_note" class="table-scrollable table-scrollable-borderless display-none">
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/admin/admin_features_form_note.js" type="text/javascript"></script>
