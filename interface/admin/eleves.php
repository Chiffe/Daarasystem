...
<html lang="fr">
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <label for="filter2">Classes :
                                                    <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! L'attribut "data-query" sert lorsque l'utilisateur a cliqué sur "Voir la classe" depuis la page classes.php, cela filtre directement le tableau !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                                                    <select class="form-control input-inline" name="filter2" <?php echo (isset($_REQUEST['classe']) && !empty($_REQUEST['classe']))?'data-query="'.$_REQUEST['classe'].'"':''; ?> id="filter_classe"></select>
                                                </label>
                                            </div>
                                        </div>
                                                    ...
                                                    <td>
                                                        <div class="btn-group-vertical">
                                                            ...
                                                            <ul class="dropdown-menu" role="menu">
                                                                ...
                                                                <li class="divider"></li>
                                                                <li>
                                                                    <a href="javascript:;" data-id="<?php echo $row['id']; ?>" class="ban_eleve"> <i class="icon-ban"></i> Exclure</a>
                                                                </li>
                                                            </ul>
                                                            <a href="javascript:;" data-id="<?php echo $row['id']; ?>" class="btn btn-xs red delete" data-toggle="confirmation" data-placement="left" data-original-title="Êtes-vous sûr ?" data-singleton="true"><i class="icon-trash"></i> Supprimer</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                            <?php endforeach;
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/admin/admin_eleves.js" type="text/javascript"></script>
