...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Admin | Carnet de note</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
        ...
        <div class="page-container">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    <!-- BEGIN PAGE HEADER-->
                    <h2 class="page-title font-green"> Admin
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                ...
                                                                <li>
                                                                    <a href="javascript:;" data-id_eleve="<?php echo $row['id']; ?>" data-id_trimes="1" class="edit"><i class="fa fa-pencil"></i> Modifier le carnet de note</a>
                                                                </li>
                                                                <li>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                ...
                                                                <li>
                                                                    <a href="javascript:;" data-id_eleve="<?php echo $row['id']; ?>" data-id_trimes="2" class="edit"><i class="fa fa-pencil"></i> Modifier le carnet de note</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"><i class="icon-printer"></i> Imprimer le carnet de note</a>
                                                                </li>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                ...
                                                                <li>
                                                                    <a href="javascript:;" data-id_eleve="<?php echo $row['id']; ?>" data-id_trimes="3" class="edit"><i class="fa fa-pencil"></i> Modifier le carnet de note</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"><i class="icon-printer"></i> Imprimer le carnet de note</a>
                                                                </li>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/admin/admin_carnet_note.js" type="text/javascript"></script>
