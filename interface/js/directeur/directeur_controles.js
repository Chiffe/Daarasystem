...
var directeurControles = function () {
    ...
    var handleTable = function() {
        ...
        table.on('click', '.view', function(){
            ...
            mainInterface.ajaxRequest('../response_ajax.php', {compte:'directeur', action:'view_notes'}, function(resAjax){
                if(resAjax.success)
    ...
    function changeFiltre(nameFiltre, idItem, labelItem){
        ...
        $('.printer_actions').prop('disabled', dataFilters.disabledBtnPrint).attr('data-original-title', 'Les notes générales'+msgFiltreTooltips);
    }
...
$(document).ready(function(){directeurControles.init();});