...
var directeurCarnetNote = function () {
    ...
    var handleTable = function() {
        ...
        table.on('click', '.view', function(){
            ...
            mainInterface.ajaxRequest('../response_ajax.php', {compte:'directeur', action:'view_carnet_note'}, function(resAjax){
                if(resAjax.success)
...
$(document).ready(function(){directeurCarnetNote.init();});