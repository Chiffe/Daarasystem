...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Comptable | Elèves abonnés</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h2 class="page-title font-green"> Comptable
                        <small class="font-green">Elèves abonnés</small>
                    </h2>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="eleve_abonnes.php">Elèves abonnés</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Facturer un élève</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    <div id="no_facture" class="row cont_facture">
                                        <div class="col-xs-12">
                                            <p class="text-center text-uppercase">sélectionner un élève pour le facturer</p>
                                        </div>
                                    </div>
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Liste des élèves abonnés</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row margin-bottom-20">
                                            <div class="col-xs-12">
                                                ...
                                                <button disabled data-html="true" data-action="trans" data-original-title="Sélectionnez au moins un filtre pour activer le bouton" class="tooltips btn grey-mint printer_actions">Les abonnés à un transport</button>
                                                <button disabled data-html="true" data-action="cant" data-original-title="Sélectionnez au moins un filtre pour activer le bouton" class="tooltips btn grey-mint printer_actions">Les abonnés à la cantine</button>
                                            </div>
                                        </div>
                                    </div>
                                    <table class="table table-striped table-hover table-bordered" id="table_abonne">
                                        <thead>
                                        <tr>
                                            <th>Cycle</th>
                                            <th>Classe</th>
                                        ...
                                        <?php
                                            $dataTable = [
                                                ['cycle' => 'Cycle 1', 'matricule' => 'mat_1',  'id' => 1,  'classe' => 'Classe 1', 'eleve' => 'Nom_A Prenom_A', 'transport' => 'Bus SOS',   'cantine' => 'N/D'],
                                                ['cycle' => 'Cycle 1', 'matricule' => 'mat_2',  'id' => 2,  'classe' => 'Classe 1', 'eleve' => 'Nom_B Prenom_B', 'transport' => 'Bus SOS',   'cantine' => 'N/D'],
                                                ['cycle' => 'Cycle 1', 'matricule' => 'mat_3',  'id' => 3,  'classe' => 'Classe 1', 'eleve' => 'Nom_C Prenom_C', 'transport' => 'Bus SOS',   'cantine' => 'N/D'],
                                                ['cycle' => 'Cycle 1', 'matricule' => 'mat_4',  'id' => 4,  'classe' => 'Classe 1', 'eleve' => 'Nom_D Prenom_D', 'transport' => 'Bus SOS',   'cantine' => 'Demi-pension'],
                                                ['cycle' => 'Cycle 1', 'matricule' => 'mat_5',  'id' => 5,  'classe' => 'Classe 1', 'eleve' => 'Nom_E Prenom_E', 'transport' => 'Bus SOS',   'cantine' => 'Demi-pension'],
                                                ['cycle' => 'Cycle 1', 'matricule' => 'mat_6',  'id' => 6,  'classe' => 'Classe 1', 'eleve' => 'Nom_F Prenom_F', 'transport' => 'Bus SOS',   'cantine' => 'Demi-pension'],
                                                ['cycle' => 'Cycle 2', 'matricule' => 'mat_7',  'id' => 7,  'classe' => 'Classe 2', 'eleve' => 'Nom_G Prenom_G', 'transport' => 'N/D',       'cantine' => 'Demi-pension'],
                                                ['cycle' => 'Cycle 2', 'matricule' => 'mat_8',  'id' => 8,  'classe' => 'Classe 2', 'eleve' => 'Nom_H Prenom_H', 'transport' => 'N/D',       'cantine' => 'Demi-pension'],
                                                ['cycle' => 'Cycle 2', 'matricule' => 'mat_9',  'id' => 9,  'classe' => 'Classe 2', 'eleve' => 'Nom_I Prenom_I', 'transport' => 'N/D',       'cantine' => 'Pension'],
                                                ['cycle' => 'Cycle 2', 'matricule' => 'mat_10', 'id' => 10, 'classe' => 'Classe 2', 'eleve' => 'Nom_J Prenom_J', 'transport' => 'Bus Privé', 'cantine' => 'Pension'],
                                                ['cycle' => 'Cycle 2', 'matricule' => 'mat_11', 'id' => 11, 'classe' => 'Classe 2', 'eleve' => 'Nom_K Prenom_K', 'transport' => 'Bus Privé', 'cantine' => 'Pension'],
                                                ['cycle' => 'Cycle 2', 'matricule' => 'mat_12', 'id' => 12, 'classe' => 'Classe 3', 'eleve' => 'Nom_L Prenom_L', 'transport' => 'Bus Privé', 'cantine' => 'Pension'],
                                                ['cycle' => 'Cycle 3', 'matricule' => 'mat_13', 'id' => 13, 'classe' => 'Classe 3', 'eleve' => 'Nom_M Prenom_M', 'transport' => 'N/D',       'cantine' => 'Pension'],
                                                ['cycle' => 'Cycle 3', 'matricule' => 'mat_14', 'id' => 14, 'classe' => 'Classe 3', 'eleve' => 'Nom_N Prenom_N', 'transport' => 'Bus Privé', 'cantine' => 'N/D'],
                                                ['cycle' => 'Cycle 3', 'matricule' => 'mat_15', 'id' => 15, 'classe' => 'Classe 4', 'eleve' => 'Nom_O Prenom_O', 'transport' => 'Bus Privé', 'cantine' => 'N/D'],
                                                ['cycle' => 'Cycle 3', 'matricule' => 'mat_16', 'id' => 16, 'classe' => 'Classe 4', 'eleve' => 'Nom_P Prenom_P', 'transport' => 'Bus Privé', 'cantine' => 'N/D'],
                                                ['cycle' => 'Cycle 3', 'matricule' => 'mat_17', 'id' => 17, 'classe' => 'Classe 4', 'eleve' => 'Nom_Q Prenom_Q', 'transport' => 'Bus Privé', 'cantine' => 'N/D']
                                            ];
                                            foreach($dataTable as $row): ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['cantine']; ?></td>
                                                    <td>
                                                        <a href="javascript:;" data-id="<?php echo $row['id']; ?>" class="btn btn-xs green facturer"><i class="fa fa-bus"></i> Facturer Transport/Cantine</a>
                                                        <a href="javascript:;" data-id="<?php echo $row['id']; ?>" class="btn btn-xs yellow-gold edit"><i class="fa fa-pencil"></i> Modifier l'abonnement</a>
                                                        <a href="javascript:;" data-id="<?php echo $row['id']; ?>" class="btn btn-xs red desabo"><i class="icon-close"></i> Désabonnement</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach;
                                        ?>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/comptable/comptable_eleve_abonnes.js" type="text/javascript"></script>
