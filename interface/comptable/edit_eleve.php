...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Comptable | Editer un élève</title>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject sbold uppercase"> Editer <?php echo $exampleData['civilite'].'. '.$exampleData['nom']; ?></span>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-xs-12 col-md-8 col-md-offset-2">
                                            <form role="form" enctype="multipart/form-data" action="undefined" method="post">
                                                ...
                                                <div class="form-body">
                                                    ...
                                                    <legend>3. Informations tuteur</legend>
                                                    <div class="row">
                                                        <div class="col-sm-6 col-md-4">
                                                            <div class="form-group form-md-line-input form-md-floating-label">
