...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Comptable | Facturer les élèves</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h2 class="page-title font-green"> Comptable
                        <small class="font-green">Facturer les élèves</small>
                    </h2>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit ">
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="table_facturer">
                                        <thead>
                                        <tr>
                                            <th>Cycle</th>
                                            <th>Classe</th>
                                        ...
                                        <?php
                                            ...
                                            foreach($dataTable as $row): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="javascript:;" data-id="<?php echo $row['id']; ?>" class="btn btn-xs green facturer"><i class="fa fa-calculator"></i> Frais de scolarité</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach;
                                        ?>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/comptable/comptable_facturer_eleves.js" type="text/javascript"></script>
