...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Comptable | Réinscrire un élève</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h2 class="page-title font-green">Comptable
                        <small class="font-green">Réinscription d'un élève</small>
                    </h2>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                ...
                                <a class="font-green" href="reinscription_eleve.php?id=<?php echo $exampleData['id']; ?>">Réinscrire <?php echo $exampleData['civilite'].'. '.$exampleData['nom']; ?></a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject sbold uppercase"> Réinscrire <?php echo $exampleData['civilite'].'. '.$exampleData['nom']; ?></span>
                                    </div>
                                </div>
