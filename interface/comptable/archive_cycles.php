...
<html lang="fr">
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h2 class="page-title font-green">Comptable
                        <small class="font-green">Archives par cycle</small>
                    </h2>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="archive_cycles.php">Archives par cycle</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Archives par cycle</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <table class="table table-striped table-hover table-bordered" id="table_archive_cycle">
                                        <thead>
                                        <tr>
                                            <th>Année Scolaire</th>
                                            <th>Tous les cycles</th>
                                            <th>Creche</th>
                                            <th>Jardin</th>
                                            <th>Primaire</th>
                                        </tr>
                                        ...
                                        <?php
                                            ...
                                            foreach($dataTable as $row): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <button class="btn btn-xs grey-mint dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                                                <i class="fa fa-print"></i> Imprimer <i class="fa fa-angle-down"></i>
                                                            </button>
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li>
                                                                    <a href="undefined"> <i class="fa fa-file"></i> Etat des encaissements par mois</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"> <i class="fa fa-file"></i> Etat des encaissements par classe</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"> <i class="fa fa-file"></i> Etat des encaissements par rubrique</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/comptable/comptable_archive_cycles.js" type="text/javascript"></script>
