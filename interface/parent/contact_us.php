...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Parent | Contactez-nous</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green"> Parent
                        <small class="font-green">Contactez-nous</small>
                    </h1>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="contact_us.php">Contactez-nous</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Contactez-nous</span>
                                    </div>
                                </div>
                                            ...
                                            <form role="form" action="undefined" method="post">
                                                ...
                                                <div class="form-body">
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <input type="text" class="form-control" name="nomparent" required="required" id="nomparent">
                                                        <label for="nomparent">Nom*</label>
                                                        <span class="help-block font-green">Exemple de message d'information</span>
                                                    </div>
                                                    <div class="form-group form-md-line-input form-md-floating-label">
                                                        <textarea class="form-control" name="message" id="message" required="required" rows="4"></textarea>
