...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Parent | Emploi du temps</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green"> Parent
                        <small class="font-green">Emploi du temps</small>
                    </h1>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="emploi_temps.php">Emploi du temps</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Emploi du temps de la classe : Classe 1</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                                            <!-----------!!!!! IMPORTANT METTRE L'ID DE LA CLASSE DANS L'ATTRIBUT CI-DESSOUS !!!!!--------------->
                                            <!--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!-->
                                            <div id="calendar" data-id="1"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="page-footer">
            ...
            <script src="../js/plugins/fullcalendar_fr.js" type="text/javascript"></script>
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/parent/parent_emploi_temps.js" type="text/javascript"></script>
