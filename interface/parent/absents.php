...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Parent | Liste des absences</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green"> Parent
                        <small class="font-green">Liste des absences</small>
                    </h1>
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="absents.php">Liste des absences</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Liste des absences</span>
                                    </div>
                                </div>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/parent/parent_absents.js" type="text/javascript"></script>
