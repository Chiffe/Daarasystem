...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Enseignant | <?php echo 'TITRE DE LA PAGE'; ?></title> <!-- A LA PLACE DU PHP, METTRE LE TITRE DE LA PAGE -->
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
                    ...
                    <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                        ...
                        <li class="nav-item">
                            <a href="devoirs.php" class="nav-link nav-toggle">
                                ...
                                <span class="title">Gestion devoirs</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="add_note.php" class="nav-link ">
                                        <span class="title">Ajouter notes</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="devoirs.php" class="nav-link ">
                                        <span class="title">Afficher notes</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item">
                                    <a href="add_note_compo.php" class="nav-link ">
                                        <span class="title">Ajouter une note comp.</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="undefined" class="nav-link ">
                                        <span class="title">Appréciation par matière</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
        ...
        <div class="page-footer">
            ...
            <!--***************************** FIN DE SECTION POUR JS DES PLUGINS DE LA PAGE ****************************************-->
