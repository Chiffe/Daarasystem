...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Enseignant | Ajouter des notes compositions</title>
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h1 class="page-title font-green">Enseignant
                        <small class="font-green">Ajouter des notes compositions</small>
                    </h1>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="add_note_compo.php">Ajouter des notes compositions</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Ajouter des notes compositions</span>
                                    </div>
                                </div>
