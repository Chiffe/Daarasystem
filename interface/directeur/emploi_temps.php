...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Directeur Enseignant | Emploi du temps</title>
        ...
        <!-- ***************************************************************************** -->
        <link href="../css/emploi_temps.css" rel="stylesheet" type="text/css">
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-green">
                                        ...
                                        <span class="caption-subject bold uppercase"> Emploi du temps des classes</span>
                                    </div>
                                </div>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/directeur/directeur_emploi_temps.js" type="text/javascript"></script>
