...
<html lang="fr">
    ...
    <head>
        <meta charset="utf-8">
        <title>Directeur Enseignant | Les notes</title>
    ...
    <body class="page-sidebar-fixed page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid">
            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                    ...
                    <h2 class="page-title font-green">Directeur Enseignant
                        <small class="font-green">Les notes</small>
                    </h2>
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            ...
                            <li>
                                <a class="font-green" href="controles.php">Les notes</a>
                            </li>
                        </ul>
                    </div>
                    <!-- END PAGE HEADER-->
                            ...
                            <div class="portlet light portlet-fit ">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-green sbold uppercase">Les notes</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="table-toolbar">
                                        <div class="row margin-bottom-20">
                                            <div class="col-xs-12">
                                                ...
                                                <button disabled data-html="true" data-original-title="Sélectionnez les filtres 'Classe' et 'Trimestre' pour activer le bouton" class="tooltips btn grey-mint printer_actions">Les notes générales</button>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li>
                                                                    <a href="javascript:;" data-id_eleve="<?php echo $row['id']; ?>" data-id_trimes="1" class="view"><i class="icon-magnifier"></i> Voir les notes</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"><i class="icon-printer"></i> Imprimer les notes</a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li>
                                                                    <a href="javascript:;" data-id_eleve="<?php echo $row['id']; ?>" data-id_trimes="2" class="view"><i class="icon-magnifier"></i> Voir les notes</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"><i class="icon-printer"></i> Imprimer les notes</a>
                                                                </li>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <ul class="dropdown-menu pull-right" role="menu">
                                                                <li>
                                                                    <a href="javascript:;" data-id_eleve="<?php echo $row['id']; ?>" data-id_trimes="3" class="view"><i class="icon-magnifier"></i> Voir les notes</a>
                                                                </li>
                                                                <li>
                                                                    <a href="undefined"><i class="icon-printer"></i> Imprimer les notes</a>
                                                                </li>
        ...
        <div class="page-footer">
            ...
            <!-- ***************************************************************************** -->
            <script src="../js/directeur/directeur_controles.js" type="text/javascript"></script>
